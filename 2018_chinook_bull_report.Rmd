...
```{r Unique Tag counts, fig.width=8,fig.height=7,message=FALSE, warning=FALSE}
...
df %>%
  ...
  facet_grid(factor(SiteID,levels=c("IR1","IR2","IR3","IR4","IML","IR5"))~Mark.Species,scales="free") +
...
>>>>>>> fdeb415199e591197587aca16f45d9078a0511a5
